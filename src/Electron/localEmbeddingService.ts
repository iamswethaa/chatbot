...
export class LocalEmbeddingService {
  ...
  private readonly modelName = 'Xenova/all-MiniLM-L6-v2'; // Same model as HuggingFace, but local
   ...
   */
  private generateSimpleEmbedding(text: string, dimension: number = 384): number[] {
   ...
   */
  getModelInfo(): { name: string; isLocal: boolean; dimensions: number } {
    return {
      name: this.modelName,
      isLocal: true,
      dimensions: 384
